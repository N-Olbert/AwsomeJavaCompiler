...
public class PointBytecodeTest
{
    ...
    public void testPoint()
    {
        ...
        try
        {
            var method = loader.getMethod(className, methodNameGetX, int.class);
        ...
        try
        {
            var method = loader.getMethod(className, methodNameGetY, int.class);
            assertEquals(int.class, method.getReturnType());
        ...
        try
        {
            ...
            var methodGet = loader.getMethod(className, methodNameGetX, int.class);
            assertEquals(int.class, methodGet.getReturnType());
            assertEquals(7, method.invoke(classObject));
        }
        catch (IllegalAccessException | NoSuchMethodException | InvocationTargetException e)
        {
        ...
        try
        {
            ...
            var methodGet = loader.getMethod(className, methodNameGetY, int.class);
            assertEquals(int.class, methodGet.getReturnType());
